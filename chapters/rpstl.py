...
<pim chngno="0" revno="0" chap-toc="no" dmwr-inclus="none">\n"""
    ...
    <para0>
        ...
        <para> UOC appears in lower left corner of Description Column heading. Usable on codes are shown as "UOC:" in Description Column (justified left) on first line under applicable item/nomenclature. Uncoded items are applicable to all models. Examples of UOCs used in this RPSTL are:<table frame="none">
                <tgroup align="left" char=" " charoff="50" cols="4">
                    <colspec colname="col0" colwidth="0.25*"/>
                    <colspec colname="col1" colwidth="1*"/>
                    <colspec colname="col2" colwidth="0.25*"/>
                    ...
                    <tbody valign="top">
                        <row>
                            <entry colsep="0" rotate="no" rowsep="0"/>
                            <entry colsep="0" morerows="0" rotate="no" rowsep="0" valign="top"></entry>
                            <entry colsep="0" rotate="no" rowsep="0"/>
                            <entry colsep="0" morerows="0" rotate="no" rowsep="0" valign="top"></entry>
                        </row>
                        <row>
        ...
        <para>Fabrication Instructions. Bulk materials required to manufacture items are listed in bulk material functional group of this RPSTL. Part numbers for bulk material are also referenced in Description Column of line item entry for item to be manufactured/fabricated. Detailed fabrication instructions for items source coded to be manufactured or fabricated are found in this manual <xref wpid="R00001-10-7360-233"/>.</para>
    ...
    <para0>
        <title/>
        <para>Associated Publications. Publication(s) listed below pertain to {self.sys_name}:
            <table frame="none">
                <tgroup align="left" char=" " charoff="50" cols="4">
