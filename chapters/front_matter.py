...
class FrontMatter:
    ...
    def title_page(self):
        ...
        tmp += '<production chngdate="11 SEPTEMBER 2022" chnglevel="0" date="11 SEPTEMBER 2022" \
            pin="XX-XXX-XX">\n'
        if self.manual_type == '-10':
            tmp += '\t<paper.manual maintitl="OPERATOR MANUAL FOR ' + self.sys_name.upper() + \
                ' (' + self.sys_acronym + ')' + '" maintlvls="10" multivolume="no" pubno="TM ' + \
                    self.sys_number + self.manual_type + '" revno="0" rpstl="no">\n'
        elif self.manual_type == '-12&P':
            tmp += '\t<paper.manual maintitl="OPERATOR AND FIELD MAINTENANCE MANUAL FOR ' + \
                self.sys_name.upper() + ' (' + self.sys_acronym + ')' + \
                    '" maintlvls="13" multivolume="no" pubno="TM ' + self.sys_number + \
                        '-12" revno="0" rpstl="yes">\n'
        elif self.manual_type == '-13&P':
            tmp += '\t<paper.manual maintitl="OPERATOR AND FIELD MAINTENANCE MANUAL FOR ' + \
                self.sys_name.upper() + ' (' + self.sys_acronym + ')' + \
                    '" maintlvls="13" multivolume="no" pubno="TM ' + \
                    self.sys_number + '-13" revno="0" rpstl="yes">\n'
        elif self.manual_type == '-23&P':
            tmp += '\t<paper.manual maintitl="REPAIR PARTS LIST FOR ' + self.sys_name.upper() + \
                ' (' + self.sys_acronym + ')' + '" maintlvls="23" multivolume="no" pubno="TM ' + \
                    self.sys_number + '-23" revno="0" rpstl="only">\n'
        tmp += self.TAB_2 + '<paper.frnt>\n'
        tmp += self.TAB_3 + '<frntcover>\n'
        tmp += self.TAB_4 + '<?Pub Dtl?>\n'
        tmp += self.TAB_4 + '<tmtitle>\n'
        if self.manual_type == '-10':
            tmp += self.TAB_5 + '<tmno>TM ' + self.sys_number + '-10</tmno>\n'
        elif self.manual_type == '-12&P':
            tmp += self.TAB_5 + '<tmno>TM ' + self.sys_number + '-12&amp;P</tmno>\n'
        elif self.manual_type == '-13&P':
            tmp += self.TAB_5 + '<tmno>TM ' + self.sys_number + '-13&amp;P</tmno>\n'
        elif self.manual_type == '-23&P':
            tmp += self.TAB_5 + '<tmno>TM ' + self.sys_number + '-23&amp;P</tmno>\n'
        tmp += self.TAB_5 + '<prtitle>\n'
        tmp += self.TAB_6 + '<sysnomen>\n'
        tmp += self.TAB_7 + '<name>' + self.sys_name + '</name>\n'
        tmp += self.TAB_7 + '<modelno>(GREEN)</modelno>\n'
        tmp += self.TAB_7 + '<nsn>\n'
        tmp += self.TAB_8 + '<fsc>' + self.fsc + '</fsc>\n'
        tmp += self.TAB_8 + '<niin>' + self.niin + '</niin>\n'
        tmp += self.TAB_7 + '</nsn>\n'
        tmp += self.TAB_7 + '<partno>' + self.part_no + '</partno>\n'
        ...
        tmp += self.TAB_5 + '</dist>\n'
        tmp += self.TAB_4 + '</notices>\n'
        tmp += self.TAB_4 + '<servnomen>' + self.config.get('HEADQUARTERS') + '</servnomen>\n'
        tmp += self.TAB_4 + '<date>11 SEPTEMBER 2022</date>\n'
        tmp += self.TAB_3 + '</frntcover>\n'

        with open(self.save_path + '/' + self.sys_acronym + ' ' + self.manual_type + \
            ' WIP/{:05d}-FrontCover.txt'.format(cfg.prefix_file), 'w', encoding='UTF-8') as _f:
            _f.write(tmp)
        cfg.prefix_file += 10
    ...
    def warning_summary(self):
        ...
        tmp += self.TAB_2 + '<para>' + self.config.get('SW_FIRSTAID') + '</para>\n'
        tmp += '\t</first_aid>\n'
        tmp += '\t<safety>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_EAR_PROTECTION') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # ELECTRICAL
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_ELECTRICAL') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # FALLING
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_FALLING') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # FALLING PARTS
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_FALLING_PARTS') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # FLYING PARTICLES
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_FLYING_PARTICLES') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # HEAVY OBJECT
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_HEAVY_OBJECT') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # HEAVY PARTS ABOVE
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_HEAVY_PARTS_ABOVE') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # HEAVY PARTS FOOT
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_3 + '<sftydesc>\n'
        tmp += self.TAB_4 + '<title>HEAVY PARTS</title>\n'
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_HEAVY_PARTS_FOOT') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # HEAVY PARTS HAND
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_3 + '<sftydesc>\n'
        tmp += self.TAB_4 + '<title>HEAVY PARTS</title>\n'
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_HEAVY_PARTS_HAND') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # HEAVY PARTS WALL
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_3 + '<sftydesc>\n'
        tmp += self.TAB_4 + '<title>HEAVY PARTS</title>\n'
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_HEAVY_PARTS_WALL') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # HOT AREA
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_HOT_AREA') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_MOVING_PARTS') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_SHARP_OBJECT') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        # SLICK FLOOR
        tmp += self.TAB_2 + '<sfty-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('SW_SLICK_FLOOR') + '</text>\n'
        tmp += self.TAB_3 + '</sftydesc>\n'
        tmp += self.TAB_2 + '</sfty-icons>\n'
        tmp += '\t</safety>\n'
        tmp += '\t<warninfo>\n'
        ...
        tmp += self.TAB_3 + '<trim.para>Interior and exterior areas of ' + \
            self.sys_acronym.upper() + \
                ' may be a wet environment. Electrical cables and controls should not be handled with wet hands or while standing in water. Failure to comply may result in serious injury or death to personnel. Seek immediate medical attention if injury occurs.</trim.para>\n'
        tmp += self.TAB_2 + '</warning>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('HM_BIOLOGICAL') + '</text>\n'
        tmp += self.TAB_3 + '</hazdesc>\n'
        tmp += self.TAB_2 + '</haz-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('HM_CHEMICAL') + '</text>\n'
        tmp += self.TAB_3 + '</hazdesc>\n'
        tmp += self.TAB_2 + '</haz-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('HM_EXPLOSION') + '</text>\n'
        tmp += self.TAB_3 + '</hazdesc>\n'
        tmp += self.TAB_2 + '</haz-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('HM_EYE_PROTECTION') + '</text>\n'
        tmp += self.TAB_3 + '</hazdesc>\n'
        tmp += self.TAB_2 + '</haz-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('HM_FIRE') + '</text>\n'
        tmp += self.TAB_3 + '</hazdesc>\n'
        tmp += self.TAB_2 + '</haz-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('HM_POISON') + '</text>\n'
        tmp += self.TAB_3 + '</hazdesc>\n'
        tmp += self.TAB_2 + '</haz-icons>\n'
        ...
        tmp += self.TAB_4 + '<text>' + self.config.get('HM_VAPOR') + '</text>\n'
        tmp += self.TAB_3 + '</hazdesc>\n'
        tmp += self.TAB_2 + '</haz-icons>\n'
        ...
        tmp += self.TAB_3 + '<symbol boardno="Chemical"/>\n'
        tmp += self.TAB_3 + '<symbol boardno="Poison"/>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('HM_CLEANING') + '</para>\n'
        tmp += self.TAB_2 + '</hazard>\n'

        tmp += self.TAB_2 + '<hazard>\n'
        tmp += self.TAB_3 + '<hazid>WASTEWATER</hazid>\n'
        tmp += self.TAB_3 + '<symbol boardno="Biological_Symbol"/>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('HM_WASTEWATER') + '</para>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('HM_WASTEWATER_2') + '</para>\n'
        tmp += self.TAB_2 + '</hazard>\n'
        ...
        tmp += self.TAB_3 + '<symbol boardno="Eye_Protection"/>\n'
        tmp += self.TAB_3 + '<symbol boardno="Vapor"/>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('HM_ISOPROPYL') + '</para>\n'
        tmp += self.TAB_2 + '</hazard>\n'

        tmp += self.TAB_2 + '<hazard>\n'
        tmp += self.TAB_3 + '<hazid>FUEL</hazid>\n'
        tmp += self.TAB_3 + '<symbol boardno="Fire"/>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('HM_FUEL') + '</para>\n'
        tmp += self.TAB_2 + '</hazard>\n'
        tmp += '\t</hazmat>\n'
        tmp += '</warnsum>\n'

        with open(self.save_path + '/' + self.sys_acronym + ' ' + self.manual_type + \
            ' WIP/{:05d}-WarningSummary.txt'.format(cfg.prefix_file), 'w', encoding='UTF-8') as _f:
            _f.write(tmp)
        cfg.prefix_file += 10
...
<howtouse>
    ...
    <para0>
        ...
        tmp += self.TAB_2 + '<para>' + self.config.get('OBTAIN_TM_P2') + '</para>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Instructions for Unit Publications Clerk</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('UNIT_PUB_CLERK_P1') + '</para>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('UNIT_PUB_CLERK_P2') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += '\t</para0>\n'
        tmp += '\t<para0>\n'
        tmp += self.TAB_2 + '<title>HOW TO USE THIS MANUAL</title>\n'
        tmp += self.TAB_2 + '<para>' + self.config.get('HOW_TO_USE') + '</para>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>FRONT MATTER</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('FRONT_MATTER') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        ...
        tmp += self.TAB_3 + '<para>' + self.config.get('OPERATOR_INSTRUCTIONS') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>CHAPTER 3 - TROUBLESHOOTING INDEX</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('TS_INDEX') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>CHAPTER 4 - CREW TROUBLESHOOTING PROCEDURES</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('CREW_TS') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>CHAPTER 5 - MAINTAINER TROUBLESHOOTING PROCEDURES</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('MAINTAINER_TS') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + \
        ...
        tmp += self.TAB_3 + '<para>' + self.config.get('CREW_MAINTENANCE') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>CHAPTER 8 - MAINTAINER MAINTENANCE INSTRUCTIONS</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('MAINTAINER_MAINTENANCE') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + \
            '<title>CHAPTER 9 - DESTRUCTION OF EQUIPMENT TO PREVENT ENEMY USE</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('DESTRUCTION') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>CHAPTER 10 - REPAIR PARTS AND SPECIAL TOOLS LIST</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('RPSTL') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>CHAPTER 11 - SUPPORTING INFORMATION</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('SUPPORTING_INFO') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>REAR MATTER</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('REAR_MATTER') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += '\t</para0>\n'
        tmp += '\t<para0>\n'
        tmp += self.TAB_2 + '<title>Manual Organization and Page Numbering System</title>\n'
        tmp += self.TAB_2 + '<para>' + self.config.get('PAGE_NUM_SYSTEM') + '</para>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        ...
        tmp += self.TAB_3 + '<para>' + self.config.get('EXAMPLE') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Alphabetical Index</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('ALPHABETICAL_INDEX') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += '''\t</para0>
            <para0>
        ...
        tmp += self.TAB_3 + '<para>' + self.config.get('TOOLS') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'

        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Materials</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('MATERIALS') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'

        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Mandatory Replacement Parts</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('MRP') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Personnel Required</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('PERSONNEL_REQUIRED') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>References</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('REFERENCES') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Equipment Condition</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('EQUPMENT_CONDITION') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Special Environmental Condition</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('SPECIAL_ENV_CONDITION') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Drawings Required</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('DRAWINGS_REQUIRED') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Estimated Time to Complete</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('EST_TIME_TO_COMPLETE') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += '\t</para0>\n'
        tmp += '\t<para0>\n'
        ...
        tmp += self.TAB_2 + '<para>' + self.config.get('HOW_TO_FIX_EQUIPMENT_MALFUNCTION') \
            + ' <!--DELETE THIS SENTENCE IF NOT USED-->\n'
        tmp += self.TAB_2 + '</para>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Preparing for a Task</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('PREP_FOR_TASK') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += self.TAB_2 + '<subpara1>\n'
        tmp += self.TAB_3 + '<title>Performing the Task</title>\n'
        tmp += self.TAB_3 + '<para>' + self.config.get('PERFORMING_TASK') + '</para>\n'
        tmp += self.TAB_2 + '</subpara1>\n'
        tmp += '\t</para0>\n'
        tmp += '</howtouse>\n'
        tmp += '</paper.frnt>\n'
