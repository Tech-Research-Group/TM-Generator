...
class FrontMatter:
    ...
    def title_page(self):
        ...
        tmp += '<production chngdate="11 SEPTEMBER 2022" chnglevel="0" date="11 SEPTEMBER 2022" pin="XX-XXX-XX">\n'
        if self.manual_type == '-10':
            ...
            tmp += '\t<paper.manual maintitl="END ITEM" maintlvls="nmwr" multivolume="no" pubno="NMWR ' + \
